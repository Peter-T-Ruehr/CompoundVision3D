...
```
![](./imgs/imported_eye_3D_plot.png){width=4in}
...
[1] "done!"
``` 
![](./imgs/search_diameter_definition.png){width=4in}
...
![](./imgs/SEM_colors_thresholds.png){width=4in}
...
```
![](./imgs/facets_auto_process.png){width=4in}

<!-- ![](./imgs/facets_auto.png){width=4in} -->
...
![](./imgs/facets_auto_final.png){width=4in}
...
![](./imgs/facet_positions_corrected.png){width=4in}
...
![](./imgs/facet_positions_corrected_w_LMs.png){width=4in}
...
### Extract pixel sizes from different ROIs
#### Head
